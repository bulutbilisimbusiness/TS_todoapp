...
const Home = () => {
  ...
  const addTodo: AddFn = async text => {
    try {
      ...
      console.log(error);
      notify("The todo was created successfully!","error")
    } finally {
      getTodos();
    }
  };
  ...
  const toggleTodo: ToggleFn = async (todo) => {
    try {
     ...
     notify("The todo was updated successfully!", "success");
      ...
      console.log(error);
      notify("Error occured while updating the todo","error");
    } finally {
      getTodos();
    }
  };
  const deleteTodo: DeleteFn = async (id) => {
    try {
      ...
      notify("The todo has been deleted", 'warning');
    } catch (error) {
      notify("The todo has been deleted", 'error');
      console.log(error);
    } finally {
      getTodos();
    }
